...
def warning0(fr, to, error):
    ...
    w2 = f'v_to not perfectly equal to v_fr, testing with an authorized error of {error}'
    warnings.warn(w2 + '\n' + w0 + '\n' + w1)
...
def test_T_1_auto_get_scale_factor_to():
    ...
    v_to = remap_vertical(v_fr, grid_fr, grid_to, axis='Z', scale_factor_fr=domcfg_fr.e3t_0)
    _assert_same_integrated_value(v_fr, v_to, e3_fr=domcfg_fr.e3t_0, e3_to=domcfg_to.e3t_0)    
